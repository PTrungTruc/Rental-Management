...
import com.example.rental_management.views.MainActivityCalendar;
...
public class AlarmService extends Service {
    ...
    private void showNotification() {
        ...
        Intent activityIntent = new Intent(this, MainActivityCalendar.class);
        PendingIntent pendingIntent = PendingIntent.getActivity(this, notificationId, activityIntent, PendingIntent.FLAG_ONE_SHOT | PendingIntent.FLAG_IMMUTABLE);
