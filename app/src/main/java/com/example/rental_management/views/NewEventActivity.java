...
//                    if (getPackageManager().hasSystemFeature(PackageManagerCompat.FEATURE_ALARM) &&
...
//                    }
    ...
    private boolean confirmInputs() {
        ...
        if (!validateNotifications()) {
            Toast.makeText(NewEventActivity.this, "You cannot set a notification to the past.", Toast.LENGTH_LONG).show();
            return false;
        }
    ...
    private class UpdateAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            if (mEvent.isNotify()) {
                ...
                ArrayList<Notification> noti = new ArrayList<>(currentNotifications);
                setAlarms(noti);
            }
    ...
    private void requestPermissionForExactAlarms() {
        // Direct the user to the settings screen to enable the permission
